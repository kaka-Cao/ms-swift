...
swift sft \
    --model /mnt/bn/capcut-search/caomingxiang/ai_search/ai/model/Qwen3-8B \
    --train_type full \
    --dataset '/mnt/bn/capcut-search/caomingxiang/ai_search/ai/data/train_7k_v2.jsonl' \
    ...
    --output_dir /mnt/bn/capcut-search/caomingxiang/ai_search/qwen3-32b_dense_train/output/Qwen3-dense-8B \
    --deepspeed zero3 \
    --report_to wandb \
